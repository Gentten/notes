...
定义对象之间的**一对多**依赖，当一个对象**状态改变**时，它的所有依赖都会收到通知并且**自动更新状态**。
...
观察者（Observer）的注册功能需要调用主题的注册监听方法，如Spring中ApplicationListener。
...
天气数据布告板会在天气信息发生改变时更新其内容，布告板有多个，并且在将来会继续增加。也可以通过 google的guava工具包
